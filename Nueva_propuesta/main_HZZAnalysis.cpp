...
void main_HZZAnalysis(int proof = 0, int option= 0)
{
  ...
  if (option==1 || option==0){
    ...
    //chain_data->Process("HZZAnalysis.cpp","data");
    //chain_data->Process("data");
  }
  ...
  if (option==2 || option==0)   {
    ...
    chain_ZqqZll->Process("HZZAnalysis.cpp","ZqqZll");
    ...
    chain_WqqZll->Process("HZZAnalysis.cpp","WqqZll");
    ...
    chain_WpqqWmlv->Process("HZZAnalysis.cpp","WpqqWmlv");
    ...
    chain_WplvWmqq->Process("HZZAnalysis.cpp","WplvWmqq");
    ...
    chain_Ztautau->Process("HZZAnalysis.cpp","Ztautau");
  }// option 2
  ...
  if (option==3 || option==0)   {
    ...
    chain_single_top_tchan->Process("HZZAnalysis.cpp","single_top_tchan");
    ...
    chain_single_antitop_tchan->Process("HZZAnalysis.cpp","single_antitop_tchan");
    ...
    chain_single_top_schan->Process("HZZAnalysis.cpp","single_top_schan");
    ...
    chain_single_antitop_schan->Process("HZZAnalysis.cpp","single_antitop_schan");
    ...
    chain_single_top_wtchan->Process("HZZAnalysis.cpp","single_top_wtchan");
    ...
    chain_single_antitop_wtchan->Process("HZZAnalysis.cpp","single_antitop_wtchan");
    ...
    chain_ttbar_lep->Process("HZZAnalysis.cpp","ttbar_lep");
    ...
    chain_Wplusenu->Process("HZZAnalysis.cpp","Wplusenu");
    ...
    chain_Wplusmunu->Process("HZZAnalysis.cpp","Wplusmunu");
    ...
    chain_Wplustaunu->Process("HZZAnalysis.cpp","Wplustaunu");
    ...
    chain_Wminusenu->Process("HZZAnalysis.cpp","Wminusenu");
    ...
    chain_Wminusmunu->Process("HZZAnalysis.cpp","Wminusmunu");
    ...
    chain_Wminustaunu->Process("HZZAnalysis.cpp","Wminustaunu");
    ...
    chain_ggH125_ZZ4lep->Process("HZZAnalysis.cpp","ggH125_ZZ4lep");
    ...
    chain_ZH125_ZZ4lep->Process("HZZAnalysis.cpp","ZH125_ZZ4lep");
    ...
    chain_WH125_ZZ4lep->Process("HZZAnalysis.cpp","WH125_ZZ4lep");
    ...
    chain_VBF125_ZZ4lep->Process("HZZAnalysis.cpp","VBFH125_ZZ4lep");
